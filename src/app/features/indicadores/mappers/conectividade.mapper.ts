...
export function mapMapaResponseToModel(
  ...
  for (const p of api.data.pontos || []) {
    ...
    pontos.push({
      ...
      ideb_2023_anos_iniciais: numeroOuNulo(p.ideb_2023_anos_iniciais),
      ideb_2023_anos_finais: numeroOuNulo(p.ideb_2023_anos_finais),
      ideb_2023_ensino_medio: numeroOuNulo(p.ideb_2023_ensino_medio),
      ideb_2023_anos_iniciais_mun: numeroOuNulo(p.ideb_2023_anos_iniciais_mun),
      ideb_2023_anos_finais_mun: numeroOuNulo(p.ideb_2023_anos_finais_mun),
      ideb_2023_ensino_medio_mun: numeroOuNulo(p.ideb_2023_ensino_medio_mun),
